import { i as increment_write_version, D as DIRTY, s as set_signal_status, C as CLEAN, U as UNOWNED, a as DERIVED, b as schedule_effect, c as active_reaction, u as untracking, d as is_runes, e as BLOCK_EFFECT, f as derived_sources, g as state_unsafe_mutation, h as active_effect, j as BRANCH_EFFECT, R as ROOT_EFFECT, k as untracked_writes, l as set_untracked_writes, M as MAYBE_DIRTY, m as get_next_sibling, n as init_operations, o as get_first_child, p as hydration_failed, q as clear_text_content, r as all_registered_events, t as root_event_handles, v as component_root, w as handle_event_propagation, x as create_text, y as branch, z as push, A as component_context, E as pop, L as LEGACY_PROPS, F as get, G as flush_sync } from "./events.js";
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<!-- the old non tailwind stylesheet, which is not imported anymore implicitly (it used to in the app.html file)\n		(we need to import both the OG app wide stylesheet and the new tailwind one, for that admin page which uses tailwind)\n		(that global tailwin stylesheet mainly has tailwind variables - it is (mostly) not actively overwriting my styles\n		= tailwind preflight styles are not applied outside of elements which have the "twp" class, the scopedPreflightStyles tailwind plugin takes care of that) \n		there are some other (small) things which are still set (the * border on everything which I had to unset, but the rest of the app seems unchanged)\n		-->\n\n		<link rel="stylesheet" href="' + assets2 + '/app.css"> \n		<meta name="viewport" content="width=device-width, initial-scale=1" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
